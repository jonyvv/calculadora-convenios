...
def load_agreement():
    path = Path("storage/convenios/RESUMEN_EMPLEADAS_DOMESTICAS_MAYO_2026_PDF_RESUMEN/2026_05.json")
    if not path.exists():
...
def test_convention_json_is_valid():
    ...
    assert agreement.metadata.agreement_id == "RESUMEN_EMPLEADAS_DOMESTICAS_MAYO_2026_PDF_RESUMEN"
